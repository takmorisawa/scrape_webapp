# Generated by Django 2.2.1 on 2019-05-26 07:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='impressions', to='polls.Book', verbose_name='書籍')),
            ],
        ),
    ]
